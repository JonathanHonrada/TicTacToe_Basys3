...
## Switches
#set_property PACKAGE_PIN V17 [get_ports {y[2]}]					
...
#set_property PACKAGE_PIN T3 [get_ports {y[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {y[2]}]
#set_property PACKAGE_PIN T2 [get_ports {y[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {y[1]}]
...
#set_property PACKAGE_PIN U17 [get_ports {submit}]						
#	set_property IOSTANDARD LVCMOS33 [get_ports {submit}]
...
##Pmod Header JA
##Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports {COL[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {COL[4]}]
##Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports {COL[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {COL[3]}]
##Sch name = JA3
set_property PACKAGE_PIN J2 [get_ports {COL[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {COL[2]}]
##Sch name = JA4
set_property PACKAGE_PIN G2 [get_ports {COL[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {COL[1]}]
##Sch name = JA7
set_property PACKAGE_PIN H1 [get_ports {ROW[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ROW[4]}]
##Sch name = JA8
set_property PACKAGE_PIN K2 [get_ports {ROW[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ROW[3]}]
##Sch name = JA9
set_property PACKAGE_PIN H2 [get_ports {ROW[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ROW[2]}]
##Sch name = JA10
set_property PACKAGE_PIN G3 [get_ports {ROW[1]}]					
